...
# Aufruf:   docker build --tag juergenzimmermann/haus:2024.04.0-bookworm .
#               ggf. --progress=plain
#               ggf. --no-cache
...
LABEL org.opencontainers.image.title="haus" \
    org.opencontainers.image.description="Appserver haus mit Basis-Image Debian Bookworm" \
