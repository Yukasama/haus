...
describe('DELETE /rest/haeuser', () => {
    ...
    test('Vorhandenes Haus loeschen', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Haus loeschen, aber ohne Token', async () => {
        // given
        const url = `/rest/${id}`;
    ...
    test('Haus loeschen, aber mit falschem Token', async () => {
        // given
        const url = `/rest/${id}`;
        const token = 'FALSCH';
        const headers: Record<string, string> = {
    ...
    test('Vorhandenes Haus als "user" loeschen', async () => {
        // given
        const url = `/rest/60`;
