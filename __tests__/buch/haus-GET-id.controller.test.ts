...
import { type HausModel } from '../../src/haus/rest/haus-get.controller.js';
...
describe('GET /rest/:id', () => {
  ...
  test('Haus zu vorhandener ID', async () => {
    ...
    // when
    const { status, headers, data }: AxiosResponse<HausModel> =
  ...
  test('Kein Haus zu nicht-vorhandener ID', async () => {
    // given
  ...
  test('Kein Haus zu falscher ID', async () => {
    // given
    const url = `/${idFalsch}`;
  ...
  test('Haus zu vorhandener ID mit ETag', async () => {
    // given
